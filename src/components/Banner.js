...
export const Banner = () => {
  ...
  const toRotate = ["Mechatronics Engineer", "Robotics Engineer", "Mechanical Enginner", "Automation Enginner"];
  const period = 2000;
